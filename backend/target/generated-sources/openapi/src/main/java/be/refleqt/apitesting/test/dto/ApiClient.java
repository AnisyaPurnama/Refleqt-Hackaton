...
import be.refleqt.apitesting.test.dto.auth.Authentication;
import be.refleqt.apitesting.test.dto.auth.HttpBasicAuth;
import be.refleqt.apitesting.test.dto.auth.HttpBearerAuth;
import be.refleqt.apitesting.test.dto.auth.ApiKeyAuth;
import be.refleqt.apitesting.test.dto.auth.OAuth;
import be.refleqt.apitesting.test.dto.auth.RetryingOAuth;
import be.refleqt.apitesting.test.dto.auth.OAuthFlow;
