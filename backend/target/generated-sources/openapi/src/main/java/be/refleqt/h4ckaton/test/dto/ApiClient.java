...
import be.refleqt.h4ckaton.test.dto.auth.Authentication;
import be.refleqt.h4ckaton.test.dto.auth.HttpBasicAuth;
import be.refleqt.h4ckaton.test.dto.auth.HttpBearerAuth;
import be.refleqt.h4ckaton.test.dto.auth.ApiKeyAuth;
import be.refleqt.h4ckaton.test.dto.auth.OAuth;
import be.refleqt.h4ckaton.test.dto.auth.RetryingOAuth;
import be.refleqt.h4ckaton.test.dto.auth.OAuthFlow;
